...
# Definimos los subconjuntos como listas (a2, a1, a0)
subconjunto_a = [(a2, a1, a0) for a2, a1, a0 in zip(range(-10, 11), range(-10, 11), range(-10, 11))if a1 == 0 and a0 == 0]
subconjunto_b = [(a2, a1, a0) for a2, a1, a0 in zip(range(-10, 11), range(-10, 11), range(-10, 11))if a1 == 2*a0]
subconjunto_c = [(a2, a1, a0) for a2, a1, a0 in zip(range(-10, 11), range(-10, 11), range(-10, 11))if a2 + a1 + a0 == 2] 
